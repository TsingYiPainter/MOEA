...
for i in range(15):
    if i <= 5:
        #pass
        EA(TestBench[i],nsga2_1_6,"NSGA-II","MaF{}".format(i+1))
    elif i == 6:
        #pass
        EA(TestBench[6],nsga2_7,"NSGA-II","MaF7")
    elif i == 7 and i ==8 :
        #pass
        EA(TestBench[i],nsga2_8_9,"NSGA-II","MaF{}".format(i+1))
    elif i>=9 and i<=11:
        #pass
        EA(TestBench[i],nsga2_10_12,"NSGA-II","MaF{}".format(i+1))
    elif i == 12:
        #pass
        EA(TestBench[12],nsga2_13,"NSGA-II","MaF13")
    elif i == 13:
        #pass
        EA(TestBench[i],nsga2_14,"NSGA-II","MaF{}".format(i+1))
    else:
        #pass
        EA(TestBench[i],nsga2_15,"NSGA-II","MaF{}".format(i+1))
